    ...
    with tab1:
        ...
        with col1:
            ...
            for index, row in df2.iterrows():
                ...
                if row['category'] == 'Document': temp_cat = '📃'
                else: temp_cat = '🔨'
        ...
        with col2:
            ...
            df3.sort_values(by='priority', ascending=True, inplace=True)
    ...
    with tab2: # add task    
        ...
        with st.form(key='form1', clear_on_submit=True):
            ...
            with c1:
                ...
                inp_3 = st.selectbox('Status',('To Do', 'In Progress', 'Done'), key=cnt+3)
                inp_5 = st.selectbox('Category',('Action', 'Document'), key=cnt+5)
    ...
    with tab3: # update task
        ...
        with st.form(key='form2', clear_on_submit=True):
            ...
            with c3:
                ...
                inp_3 = st.selectbox('Status',('To Do', 'In Progress', 'Done'), index = ['To Do', 'In Progress', 'Done'].index(df['status'][df['id'] == inp_0].values[0]), key=cnt+3)
                inp_5 = st.selectbox('Category',('Action', 'Document'), index = ['Action', 'Document'].index(df['category'][df['id'] == inp_0].values[0]), key=cnt+5)
